...
4b. **US-04b** Jalon 1 : vidéo-poker façon ASN — *machine à états et binaire faits, sprint 1* ; reste : quitte ou double, validation sur émulateur/matériel.
...
| 1 | 2026-09-16 | US-03, US-04, US-04b (vidéo-poker jouable en C) | en cours — reste la validation sur émulateur |
